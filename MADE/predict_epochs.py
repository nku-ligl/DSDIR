...
def predict_epochs(feat_dir, model_dir, made_dir, TRAIN, TEST, DEVICE, epoch, dataset_name, corruption_type):
    ...
    # Get dataset.=
    data = get_data('myData', feat_dir, train_type, test_type)
    ...
    with open(os.path.join(made_dir, '%s_%s_%d_MADE_%s_%s'%(test_type, train_type, epoch, dataset_name, corruption_type)), 'w') as fp:
