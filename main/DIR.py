...
parser = argparse.ArgumentParser(description="示例脚本，包含两个参数：corruption_ratio 和 select_ratio。")

# 添加 数据集名称
parser.add_argument('--dataset_name', type=str, default='BoAu', help='数据集')

# 噪声类型
parser.add_argument('--corruption_type', type=str, default='asym', help='噪声比')

# 添加 corruption_ratio 参数
parser.add_argument('--corruption_ratio', type=float, default=0.8, help='噪声比')
...
# 根据参数构造文件名
be_ceshi_filename = f'data/feat/{args.dataset_name}/{args.corruption_type}/be_ceshi_{args.corruption_ratio}_{args.select_ratio}.npy'
ma_ceshi_filename = f'data/feat/{args.dataset_name}/{args.corruption_type}/ma_ceshi_{args.corruption_ratio}_{args.select_ratio}.npy'
ceshi_filename = f'data/feat/{args.dataset_name}/{args.corruption_type}/ceshi_{args.corruption_ratio}_{args.select_ratio}.npy'
remaining_file = f'data/feat/{args.dataset_name}/{args.corruption_type}/remaining_0_ceshi_{args.corruption_ratio}_{args.select_ratio}.npy'
...
# file_name = f'_{args.dataset_name}_{args.corruption_ratio}_{args.select_ratio}_{args.beta}_{args.warm_up}'
...
# 构建文件名
file_name = f'result/{args.dataset_name}/{args.corruption_type}/ratio_{args.corruption_ratio}/select_{args.select_ratio}/beta_{args.beta}/warmup_{args.warm_up}'
